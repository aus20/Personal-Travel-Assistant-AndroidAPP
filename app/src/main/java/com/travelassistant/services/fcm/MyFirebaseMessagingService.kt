...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendNotification(title: String, messageBody: String, data: Map<String, String>) {
        ...
        val notificationBuilder = NotificationCompat.Builder(this, channelId)
            .setSmallIcon(R.drawable.baseline_flight_24) // Uygulama ikonun (Status bar için transparan arkaplanlı beyaz bir ikon daha iyi görünür)
        ...
        // Inside sendNotification, before notificationManager.notify(...) 1
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            // 2
            if (channel == null) {
                Log.e(tag, "CRITICAL: Notification channel with ID '$channelId' was NOT found/created!")
            }
